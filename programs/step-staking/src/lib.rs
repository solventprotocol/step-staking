...
pub mod constants {
    pub const STEP_TOKEN_MINT_PUBKEY: &str = "svtMpL5eQzdmB3uqK9NXaQkq8prGZoKQFNVJghdWCkV";
    pub const X_STEP_TOKEN_MINT_PUBKEY: &str = "xsvtzXdo6tMD59k6NnYmRTi4ZduEoUSvSb6Keny73sr";
}
